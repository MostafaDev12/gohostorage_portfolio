(function ($) {
    ...
    $(document).on('click', '.submit', function () {
        ...
        // Native GET to absolute URLs (e.g. WHMCS cart on another host); $.ajax POST causes CORS.
        var formMethod = (formObj.attr('method') || 'get').toLowerCase();
        if (formMethod === 'get' && actionURL && /^https?:\/\//i.test(actionURL)) {
            return true;
        }
