...
class Server extends Model
{
    ...
    {
        return $this->attributes['image'] ? asset('uploads/servers/' . $this->attributes['image']) : asset('assets/dashboard/images/noimage.png');
    }
    public function getIconPathAttribute()
    {
        return $this->attributes['icon'] ? asset('uploads/servers/' . $this->attributes['icon']) : asset('assets/dashboard/images/noIcon.png');
    }
