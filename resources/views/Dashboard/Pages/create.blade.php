                    ...
                    <form action="{{ route('dashboard.pages.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" id="myeditorinstance" name="content_en" type="text" placeholder="{{__('dashboard.content_en')}}">{!! old('content_en') !!}</textarea>
                            </div>

                            <div class="form-group col-md-6">
                                <label class="">{{__('dashboard.content_ar')}}</label>
                                <textarea class="form-control" id="myeditorinstance" name="content_ar" type="text" placeholder="{{__('dashboard.content_ar')}}">{!! old('content_ar') !!}</textarea>
                            </div>
