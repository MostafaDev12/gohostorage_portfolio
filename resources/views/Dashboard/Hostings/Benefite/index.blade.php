                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="page-title-right d-flex justify-content-end">
                                <div class="btn btn-list">
                                    <a href="{{ route('dashboard.hostings.benefits.create',$hosting->id) }}"><button class="btn ripple btn-primary"><i class="fas fa-plus-circle"></i> {{__('dashboard.add')}}</button></a>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr id="{{ $benefit->id }}">
                                    ...
                                    <td><a
                                            ...
                                            $benefit->id}}</a></td>
                                    <td><a
                                            href="{{ route('dashboard.hostings.benefits.edit', [$hosting->id,$benefit->id]) }}">{{$benefit->title_en
                                            }}</a></td>
                                    <td><a
                                            href="{{ route('dashboard.hostings.benefits.edit', [$hosting->id,$benefit->id]) }}">{{
                                    ...
                                    <td>
                                        <form action="{{ route('dashboard.hostings.benefits.destroy',[$hosting->id,$benefit->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
