                    ...
                    <form action="{{ route('dashboard.sliders.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" name="title2_en" type="text" value="{{old('secound_title_en')}}" placeholder="{{__('dashboard.secound_title_en')}}" >
                            </div>

                            <div class="form-group col-md-4">
                                <label class="">{{__('dashboard.secound_title_ar')}}</label>
                                <input class="form-control" name="title2_ar" type="text" value="{{old('secound_title_ar')}}" placeholder="{{__('dashboard.secound_title_ar')}}" >
                            </div>
