                                            ...
                                            <div class="col-md-12 mb-6 head-border">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-check col-2">
                                                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" class="form-check-input permission-checkbox-{{ $group }} permission-checkbox" id="permission-{{ $permission->id }}" {{ in_array($permission->name, $adminPermissions) ? 'checked' : '' }}>
