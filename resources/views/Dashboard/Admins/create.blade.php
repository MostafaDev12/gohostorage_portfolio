                    ...
                    <form action="{{ route('dashboard.admins.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" name="name" type="text" value="{{old('name')}}" placeholder="{{__('dashboard.name')}}">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" name="password" type="password" placeholder="{{__('dashboard.password')}}">
                            </div>

                            <div class="form-group col-md-6">
                                <label class="">{{ __('dashboard.confirm_password') }}</label>
                                <input class="form-control" name="password_confirmation" type="password" placeholder="{{__('dashboard.password')}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="row mt-4">
