<x-dashboard.layout :title="$hosting->name . ' ' . __('dashboard.add_Benefit')">

    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="$hosting->name . ' ' . __('dashboard.add_Benefit')" :label_url="route('dashboard.hostings.edit',$hosting->id)" :label="$hosting->name . ' ' .__('dashboard.Benefits')" />
    <!-- End Page Header -->
        ...
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.hostings.benefits.store',$hosting->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
