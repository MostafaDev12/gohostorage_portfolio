<x-dashboard.layout :title="__('dashboard.add_server')">

    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="__('dashboard.add_server')" :label_url="route('dashboard.servers.index')" :label="__('dashboard.servers')" />
    <!-- End Page Header -->
        ...
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">{{ __('dashboard.add_server') }}</h4>
                </div>

                <div class="card-body">

                    <form action="{{ route('dashboard.servers.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
