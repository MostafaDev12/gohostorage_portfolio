                    ...
                    <form action="{{ route('dashboard.attributes.update',[$attribute->id]) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="order">{{__('dashboard.order')}}</label>
                                <input class="form-control" name="order" type="number" value="{{old('order', $attribute->order)}}" placeholder="{{__('dashboard.order')}}" >
                            </div>
