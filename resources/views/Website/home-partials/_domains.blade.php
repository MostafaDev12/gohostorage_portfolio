    ...
    <div class="container">
        ...
        <div class="row contact-form-style-06 position-relative justify-content-center pb-30px">
            <div class="col-xl-12">
                ...
                <form class="row justify-content-center" action="{{ config('whmcs.url') }}/cart.php" method="get">
        ...
        <div class="row row-cols-2 row-cols-lg-4 row-cols-sm-2 justify-content-center"
        ...
        <div class="row mt-5 xs-mt-7">
            <div class="col-12 text-center"
                ...
                <div class="text-dark-gray d-inline-block align-middle fw-500 fs-20 ls-minus-05px"><span
                        class="fw-700">18+ million</span> {{ __('website.customers trust us with their domains.') }}</div>
            </div>
        </div>
    </div>
</section>
