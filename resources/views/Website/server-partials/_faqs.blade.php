    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 position-relative md-mb-25px"
                ...
                <h2 class="fw-700 text-dark-gray ls-minus-2px">{{ $hosting->name . ' ' . __('website.faqs') }}</h2>
            ...
            <div class="col-lg-7 offset-lg-1">
                <div class="accordion accordion-style-02" id="accordion-style-02"
                    ...
                    @foreach ($hosting->faqs as $key=>$faq )
                    <div class="accordion-item active-accordion">
                        ...
                        <div id="accordion-style-02-0{{ $key }}" class="accordion-collapse collapse {{ $key == 0 ? 'show' : '' }}"
