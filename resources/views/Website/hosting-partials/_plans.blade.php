<section>
    <div class="container-fluid">
        <div class="row justify-content-center mb-3">
            <div class="col-xl-6 col-lg-6 col-md-7 text-center"
                data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <span
                    class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-34 fw-600 border-radius-100px bg-solitude-blue d-inline-block">
                    pricing
                </span>
                <h2 class="text-dark-gray alt-font fw-700 ls-minus-1px">Choose Hosting Plan</h2>
            </div>
        </div>
        <div class="row pricing-table-style-05 mb-5 background-position-center background-no-repeat row-cols-1 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 justify-content-center ps-8 pe-8 lg-px-0"
            ...
            <div class="col-lg-3 col-md-6 mb-30px  card-border border-radius-6px {{$plan->lable ? 'active p-0' : '' }}">
                <div class="border-radius-6px position-relative overflow-hidden pricing-card">
                    <div
                        ...
                        <span
                            class="ps-25px pe-25px mb-15px text-uppercase text-base-color fs-13 lh-34 fw-700 border-radius-100px bg-solitude-blue d-inline-block plan-label">
                            {{ $plan->lable }}
                        </span>
                        ...
                        <div class="col text-center  align-items-center justify-content-center ps-30px ">
                            <h3 class="alt-font text-dark-gray mb-0 me-15px fw-700 ls-minus-2px">
                                {{ $plan->monthly_price . ' ' . config('app.currency') }}
                            </h3>
                            <p class="fs-15 lh-22 text-start">Per user/month billed annually*</p>
                        </div>
                    </div>
                        <div class="pricing-footer ps-15px pe-15px text-center">
